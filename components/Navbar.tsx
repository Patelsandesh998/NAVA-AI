          ...
          <DropdownMenuTrigger asChild>
            <button className="flex items-center space-x-3 hover:bg-muted/50 rounded-lg p-2 transition-colors">
              ...
              <div className="hidden sm:block">
                <div className="text-sm font-medium">Sandesh Patel</div>
              </div>
            </button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-56 bg-card/95 backdrop-blur-xl">
            <div className="px-3 py-2">
              <p className="text-sm font-medium">Sandesh Patel</p>
              <p className="text-xs text-muted-foreground">sandeshpatel@example.com</p>
            </div>
